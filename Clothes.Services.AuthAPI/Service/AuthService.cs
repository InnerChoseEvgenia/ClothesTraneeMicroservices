using Clothes.Services.AuthAPI.Data;
using Clothes.Services.AuthAPI.Models;
using Clothes.Services.AuthAPI.Models.Dto;
using Clothes.Services.AuthAPI.Service.IService;
using Microsoft.AspNetCore.Identity;

namespace Clothes.Services.AuthAPI.Service
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResponseDto> Login (LoginRequestDto loginRequestDto)
        {
            ...
            //if else was found,Generate JWT Token
